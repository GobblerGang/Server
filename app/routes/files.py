...
import os
from app.utils.auth import login_required, users
from app.utils.file_ops import files, get_user_files, can_access_file
...
def get_files():
    ...
    owned_files, shared_files = get_user_files(username)
    return jsonify({
...
def download_file(filename):
    ...
    if not can_access_file(username, filename):
